...
## 8. 빈 오브젝트 생성 : Shift + Alt + N
> 오브젝트를 만들때 바로 오브젝트를 만드는 것 보다 빈 오브젝트 아래에 여러가지를 쌓아서 만드는 경우가 많습니다.
> <br>그때마다 마우스 오른쪽 클릭해서 [Create Empty]를 하기보다 단축키를 쓰는 방법이 더 편리합니다.
>  <br>![image](./Key_Pic/empty1.png)
---
